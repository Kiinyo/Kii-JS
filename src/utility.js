...
Kii.pRNG = {
    _seed: 38,
    _table: [0.87, 0.07, 0.38, 0.28, 0.97, 0.80, 0.25, 0.24, 0.21, 0.79, 
              0.03, 0.66, 0.37, 0.50, 0.06, 0.81, 0.78, 0.75, 0.94, 0.89, 
              0.67, 0.43, 0.86, 0.42, 0.62, 0.17, 0.70, 0.52, 0.46, 0.63, 
              0.20, 0.48, 0.98, 0.72, 0.22, 0.56, 0.10, 0.39, 0.96, 0.74, 
              0.85, 0.47, 0.16, 0.55, 0.64, 0.04, 0.90, 0.44, 0.41, 0.68, 
              0.27, 0.09, 0.33, 0.83, 0.05, 0.31, 0.61, 0.32, 0.36, 0.57, 
              0.18, 0.82, 0.84, 0.59, 0.76, 0.91, 0.13, 0.00, 0.51, 0.02, 
              0.35, 0.99, 0.34, 0.77, 0.88, 0.73, 0.45, 0.08, 0.12, 0.93, 
              0.15, 0.58, 0.53, 0.65, 0.49, 0.26, 0.40, 0.23, 0.92, 0.19, 
              0.11, 0.14, 0.01, 0.60, 0.71, 0.30, 0.54, 0.95, 0.69, 0.29],    
    g: function (inc) {
        inc = inc || 1
        this._seed = (this._seed + inc) % 100
        return this._table[this._seed]
    }
} 