...
KNG = { //Just a Rivest Cipher 4
    ...
    init: function (seed) {
        ...
        this.index2 = 0
        for (this.index1 = 0; this.index1 < 100; this.index1++) {
            this.index2 = (this.index2 + this.Permutations[this.index1] + this.seed) % 100
            this.swap()
        }
    },
    output: function () {
        ...
        this.swap()
        return this.Permutations[(this.Permutations[this.index1] + this.Permutations[this.index2]) % 100] / 100
    }
}